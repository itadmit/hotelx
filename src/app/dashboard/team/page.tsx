...
export default function TeamPage() {
  ...
  const members = [
    { name: "John Doe", role: "Manager", email: "john@hotel.com", status: "Active", lastActive: "Now", avatar: "JD", color: "bg-indigo-100 text-indigo-700" },
    { name: "Sarah Jenkins", role: "Reception", email: "sarah@hotel.com", status: "Active", lastActive: "5m ago", avatar: "SJ", color: "bg-pink-100 text-pink-700" },
    { name: "Mike Taylor", role: "Service Staff", email: "mike@hotel.com", status: "Active", lastActive: "1h ago", avatar: "MT", color: "bg-blue-100 text-blue-700" },
    { name: "Jessica Miller", role: "Service Staff", email: "jessica@hotel.com", status: "Away", lastActive: "2h ago", avatar: "JM", color: "bg-yellow-100 text-yellow-700" },
  ];
